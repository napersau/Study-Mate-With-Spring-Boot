        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Study Mate</span>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              Nền tảng học tiếng Anh trực tuyến hàng đầu với phương pháp giảng dạy hiện đại và hiệu quả.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/courses" className="text-sm hover:text-primary-500 transition-colors">
                  Khóa học
                </Link>
              </li>
              <li>
                <Link to="/teachers" className="text-sm hover:text-primary-500 transition-colors">
                  Giáo viên
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/refund" className="text-sm hover:text-primary-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:info@studymate.com" className="text-sm hover:text-primary-500 transition-colors">
                  info@studymate.com
                </a>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+84123456789" className="text-sm hover:text-primary-500 transition-colors">
                  +84 123 456 789
                </a>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link to="/sitemap" className="text-sm text-gray-400 hover:text-primary-500 transition-colors">
                Sitemap
              </Link>
              <Link to="/accessibility" className="text-sm text-gray-400 hover:text-primary-500 transition-colors">
                Accessibility
              </Link>
              <Link to="/cookies" className="text-sm text-gray-400 hover:text-primary-500 transition-colors">
                Cookie Policy
              </Link>
            </div>
          </div>
